...
export const teams: Team[] = [
  ...
  { id: 'brazil', name: 'Brazil', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'argentina', name: 'Argentina', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'france', name: 'France', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'spain', name: 'Spain', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'england', name: 'England', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'germany', name: 'Germany', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'portugal', name: 'Portugal', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'italy', name: 'Italy', category: ['national', 'strong'], type: 'national' },
  { id: 'netherlands', name: 'Netherlands', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  { id: 'belgium', name: 'Belgium', category: ['national', 'strong', 'world-cup-2026'], type: 'national' },
  
  // National Teams - Average
  { id: 'croatia', name: 'Croatia', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'serbia', name: 'Serbia', category: ['national', 'average'], type: 'national' },
  { id: 'switzerland', name: 'Switzerland', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'uruguay', name: 'Uruguay', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'mexico', name: 'Mexico', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'usa', name: 'USA', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'japan', name: 'Japan', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  ...
  { id: 'turkey', name: 'Turkey', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'sweden', name: 'Sweden', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'norway', name: 'Norway', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'ukraine', name: 'Ukraine', category: ['national', 'average'], type: 'national' },
  
  // National Teams - Weak
  { id: 'austria', name: 'Austria', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'hungary', name: 'Hungary', category: ['national', 'weak'], type: 'national' },
  { id: 'czech-republic', name: 'Czech Republic', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  ...
  { id: 'south-korea', name: 'South Korea', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  ...
  { id: 'scotland', name: 'Scotland', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  ...
  // FIFA World Cup 2026 — additional qualified nations
  { id: 'canada', name: 'Canada', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'south-africa', name: 'South Africa', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'bosnia-herzegovina', name: 'Bosnia and Herzegovina', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'qatar', name: 'Qatar', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'morocco', name: 'Morocco', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'haiti', name: 'Haiti', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'paraguay', name: 'Paraguay', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'australia', name: 'Australia', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'curacao', name: 'Curaçao', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'ivory-coast', name: 'Ivory Coast', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'ecuador', name: 'Ecuador', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'tunisia', name: 'Tunisia', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'egypt', name: 'Egypt', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'iran', name: 'Iran', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'new-zealand', name: 'New Zealand', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'cape-verde', name: 'Cape Verde', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'saudi-arabia', name: 'Saudi Arabia', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'senegal', name: 'Senegal', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'iraq', name: 'Iraq', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'algeria', name: 'Algeria', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'jordan', name: 'Jordan', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'dr-congo', name: 'DR Congo', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'uzbekistan', name: 'Uzbekistan', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
  { id: 'colombia', name: 'Colombia', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'ghana', name: 'Ghana', category: ['national', 'average', 'world-cup-2026'], type: 'national' },
  { id: 'panama', name: 'Panama', category: ['national', 'weak', 'world-cup-2026'], type: 'national' },
...
/** Full FIFA World Cup 2026™ qualifier list in draw order (Groups A–L). Same nations as `world-cup-2026` tags above. */
export const worldCup2026TeamIds: readonly string[] = [
  'mexico',
  'south-africa',
  'south-korea',
  'czech-republic',
